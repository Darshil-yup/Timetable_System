...
const CSE_IOT_7_SEM_TIMETABLE: TimetableEntry[] = [
    // Monday
    { id: 'ciot7-mon-1', subject: 'PE-III: NNFL/AWN/DM', lecturer: 'PAB, GA', room: 'EL-204/EL 203', day: 'Monday', time: '11:00-12:00', type: 'Lecture', duration: 1, color: 'hsl(var(--chart-1))' },
...
const CT_7_SEM_A_TIMETABLE: TimetableEntry[] = [
    // Monday
    { id: 'ct7a-mon-1', subject: 'PE-III: NNFL/AWN/DM', lecturer: 'PG/NUS/PI', room: 'ARCH AG 02B/EL-211/EL-203', day: 'Monday', time: '10:00-11:00', type: 'Lecture', duration: 1, color: 'hsl(var(--chart-1))' },
    { id: 'ct7a-mon-2', subject: 'ORO', lecturer: 'SJK', room: 'EL-211', day: 'Monday', time: '11:00-12:00', type: 'Lecture', duration: 1, color: 'hsl(var(--chart-2))' },
    { id: 'ct7a-mon-3', subject: 'Recess', lecturer: 'N/A', room: 'N/A', day: 'Monday', time: '12:00-01:00', type: 'Recess', duration: 1, color: '#E0E0E0' },
    { id: 'ct7a-mon-4', subject: 'PE-IV: CF/ML/CRM', lecturer: 'POOJA B./SST/GKY', room: 'ARCH AG 02B/EL-203/EL-211', day: 'Monday', time: '01:00-02:00', type: 'Lecture', duration: 1, color: 'hsl(var(--chart-3))' },
    { id: 'ct7a-mon-5', subject: 'PE-V: INLP/ES/CV', lecturer: 'GMD/SPP/SB', room: 'AIDS LAB-2/ARCH AG 02B/EL-211', day: 'Monday', time: '02:00-03:00', type: 'Lecture', duration: 1, color: 'hsl(var(--chart-4))' },
    { id: 'ct7a-mon-6', subject: 'PROJECT', lecturer: 'N/A', room: 'N/A', day: 'Monday', time: '03:00-04:00', type: 'Practical', duration: 1, color: '#E0E0E0' },
    { id: 'ct7a-mon-7', subject: 'LIBRARAY', lecturer: 'AJ', room: 'N/A', day: 'Monday', time: '04:00-05:00', type: 'Library', duration: 1, color: '#E0E0E0' },
    ...
    { id: 'ct7a-tue-2', subject: 'ORO', lecturer: 'SJK', room: 'EL-211', day: 'Tuesday', time: '11:00-12:00', type: 'Lecture', duration: 1, color: 'hsl(var(--chart-2))' },
    { id: 'ct7a-tue-3', subject: 'Recess', lecturer: 'N/A', room: 'N/A', day: 'Tuesday', time: '12:00-01:00', type: 'Recess', duration: 1, color: '#E0E0E0' },
    { id: 'ct7a-tue-4', subject: 'PE-IV: CF/ML/CRM', lecturer: 'POOJA B./SST/GKY', room: 'ARCH AG 02B/EL-203/EL-211', day: 'Tuesday', time: '01:00-02:00', type: 'Lecture', duration: 1, color: 'hsl(var(--chart-3))' },
    { id: 'ct7a-tue-5', subject: 'PE-V: INLP/ES/CV', lecturer: 'GMD/SPP/SB', room: 'AIDS LAB-2/ARCH AG 02B/AIDS Lab 1', day: 'Tuesday', time: '02:00-03:00', type: 'Lecture', duration: 1, color: 'hsl(var(--chart-4))' },
    { id: 'ct7a-tue-6', subject: 'PE-III: NNFL/AWN/DM', lecturer: 'PG/NUS/PI', room: 'ARCH AG 02B/EL-211/EL-203', day: 'Tuesday', time: '03:00-04:00', type: 'Lecture', duration: 1, color: 'hsl(var(--chart-1))' },
    { id: 'ct7a-tue-7', subject: 'PROJECT', lecturer: 'N/A', room: 'N/A', day: 'Tuesday', time: '04:00-05:00', type: 'Practical', duration: 1, color: '#E0E0E0' },

    // Wednesday
    { id: 'ct7a-wed-1', subject: 'PE: IV LAB:CF/ML/CRM', lecturer: 'POOJA B,AJ/SST,Priya K/GKY,Rina P', room: 'CT LAB-4/CT LAB-3/CT LAB-2', day: 'Wednesday', time: '10:00-11:00', type: 'Practical', duration: 2, batches: ['B1','B2'], color: 'hsl(var(--chart-5))' },
    { id: 'ct7a-wed-2', subject: 'Recess', lecturer: 'N/A', room: 'N/A', day: 'Wednesday', time: '12:00-01:00', type: 'Recess', duration: 1, color: '#E0E0E0' },
    { id: 'ct7a-wed-3', subject: 'PE-IV: CF/ML/CRM', lecturer: 'POOJA B./SST/GKY', room: 'ARCH AG 02B/EL-203/EL-211', day: 'Wednesday', time: '01:00-02:00', type: 'Lecture', duration: 1, color: 'hsl(var(--chart-3))' },
    { id: 'ct7a-wed-4', subject: 'PE-V: INLP/ES/CV', lecturer: 'GMD/SPP/SB', room: 'AIDS LAB-2/ARCH AG 02B/CT Lab 3', day: 'Wednesday', time: '02:00-03:00', type: 'Lecture', duration: 1, color: 'hsl(var(--chart-4))' },
    { id: 'ct7a-wed-5', subject: 'PE-III: NNFL/AWN/DM', lecturer: 'PG/NUS/PI', room: 'ARCH AG 02B/EL-211/CT-LAB 4', day: 'Wednesday', time: '03:00-04:00', type: 'Lecture', duration: 1, color: 'hsl(var(--chart-1))' },
    { id: 'ct7a-wed-6', subject: 'ORO', lecturer: 'SJK', room: 'EL-211', day: 'Wednesday', time: '04:00-05:00', type: 'Lecture', duration: 1, color: 'hsl(var(--chart-2))' },
...
const AIDS_3_SEM_B_TIMETABLE: TimetableEntry[] = [
    ...
    { id: 'aids3b-mon-3', subject: 'LA', lecturer: 'NAB', room: 'EL-303', day: 'Monday', time: '12:00-01:00', type: 'Lecture', duration: 1, color: 'hsl(var(--chart-2))' },
    { id: 'aids3b-mon-4', subject: 'Recess', lecturer: 'N/A', room: 'N/A', day: 'Monday', time: '01:00-02:00', type: 'Recess', duration: 1, color: '#E0E0E0' },
    { id: 'aids3b-mon-5', subject: 'DS', lecturer: 'PVB', room: 'EL-303', day: 'Monday', time: '02:00-03:00', type: 'Lecture', duration: 1, color: 'hsl(var(--chart-3))' },
    { id: 'aids3b-mon-6', subject: 'LAB: SDS/DS', lecturer: 'KPK,PG/PVB, S. SABA', room: 'AIDS LAB2/AIDS LAB 1', day: 'Monday', time: '03:00-04:00', type: 'Practical', duration: 2, batches: ['B1','B2','B3','B4'], color: 'hsl(var(--chart-4))' },
    ...
    { id: 'aids3b-tue-2', subject: 'LAB: SDS/DS', lecturer: 'KPK,PG/PVB, S. SABA', room: 'AIDS LAB2/AIDS LAB 3,4', day: 'Tuesday', time: '11:00-12:00', type: 'Practical', duration: 2, batches: ['B3','B4','B1','B2'], color: 'hsl(var(--chart-5))' },
    { id: 'aids3b-tue-3', subject: 'Recess', lecturer: 'N/A', room: 'N/A', day: 'Tuesday', time: '01:00-02:00', type: 'Recess', duration: 1, color: '#E0E0E0' },
    { id: 'aids3b-tue-4', subject: 'ESPM', lecturer: 'ARB', room: 'EL-303', day: 'Tuesday', time: '02:00-03:00', type: 'Lecture', duration: 1, color: 'hsl(var(--chart-2))' },
    { id: 'aids3b-tue-5', subject: 'DS', lecturer: 'PVB', room: 'EL-303', day: 'Tuesday', time: '03:00-04:00', type: 'Lecture', duration: 1, color: 'hsl(var(--chart-3))' },

    // Wednesday
    { id: 'aids3b-wed-1', subject: 'SDS', lecturer: 'KRS', room: 'EL-102', day: 'Wednesday', time: '10:00-11:00', type: 'Lecture', duration: 1, color: 'hsl(var(--chart-4))' },
    { id: 'aids3b-wed-2', subject: 'LA', lecturer: 'NAB', room: 'EL-303', day: 'Wednesday', time: '11:00-12:00', type: 'Lecture', duration: 1, color: 'hsl(var(--chart-2))' },
    { id: 'aids3b-wed-3', subject: 'DS', lecturer: 'PVB', room: 'EL-303', day: 'Wednesday', time: '12:00-01:00', type: 'Lecture', duration: 1, color: 'hsl(var(--chart-3))' },
    { id: 'aids3b-wed-4', subject: 'Recess', lecturer: 'N/A', room: 'N/A', day: 'Wednesday', time: '01:00-02:00', type: 'Recess', duration: 1, color: '#E0E0E0' },
    { id: 'aids3b-wed-5', subject: 'ESPM', lecturer: 'ARB', room: 'EL-303', day: 'Wednesday', time: '02:00-03:00', type: 'Lecture', duration: 1, color: 'hsl(var(--chart-2))' },
    { id: 'aids3b-wed-6', subject: 'FOME', lecturer: 'SSN', room: 'EL-303', day: 'Wednesday', time: '03:00-04:00', type: 'Lecture', duration: 1, color: 'hsl(var(--chart-5))' },

    // Thursday
    { id: 'aids3b-thu-1', subject: 'SDS', lecturer: 'KRS', room: 'EL-102', day: 'Thursday', time: '10:00-11:00', type: 'Lecture', duration: 1, color: 'hsl(var(--chart-4))' },
    { id: 'aids3b-thu-2', subject: 'FOME', lecturer: 'SSN', room: 'EL-303', day: 'Thursday', time: '11:00-12:00', type: 'Lecture', duration: 1, color: 'hsl(var(--chart-5))' },
    ...
    { id: 'aids3b-thu-5', subject: 'MDM 1: BDS/MDM2:Front End', lecturer: 'AG/Nirmik', room: 'EL-302/EL-303', day: 'Thursday', time: '02:00-03:00', type: 'Lecture', duration: 1, color: 'hsl(var(--chart-1))' },
    { id: 'aids3b-thu-6', subject: 'LA', lecturer: 'NAB', room: 'EL-303', day: 'Thursday', time: '03:00-04:00', type: 'Lecture', duration: 1, color: 'hsl(var(--chart-2))' },

    // Friday
    { id: 'aids3b-fri-1', subject: 'SDS', lecturer: 'KRS', room: 'EL-102', day: 'Friday', time: '10:00-11:00', type: 'Lecture', duration: 1, color: 'hsl(var(--chart-4))' },
    { id: 'aids3b-fri-2', subject: 'LA', lecturer: 'NAB', room: 'EL-303', day: 'Friday', time: '11:00-12:00', type: 'Lecture', duration: 1, color: 'hsl(var(--chart-2))' },
    { id: 'aids3b-fri-3', subject: 'DS', lecturer: 'PVB', room: 'EL-303', day: 'Friday', time: '12:00-01:00', type: 'Lecture', duration: 1, color: 'hsl(var(--chart-3))' },
    { id: 'aids3b-fri-4', subject: 'Recess', lecturer: 'N/A', room: 'N/A', day: 'Friday', time: '01:00-02:00', type: 'Recess', duration: 1, color: '#E0E0E0' },
    { id: 'aids3b-fri-5', subject: 'MDM 1: BDS/MDM2:Front End', lecturer: 'AG/Nirmik', room: 'EL-302/EL-303', day: 'Friday', time: '02:00-03:00', type: 'Lecture', duration: 1, color: 'hsl(var(--chart-1))' },
...
const AIDS_5_SEM_A_TIMETABLE: TimetableEntry[] = [
    // Monday
    { id: 'aids5a-mon-1', subject: 'PE I: LAB: CN/HPC', lecturer: 'ABP, Reena Parteki, Sharayu K, K Khandare', room: 'AIDS LAB 2/AIDS LAB 5,6', day: 'Monday', time: '10:00-11:00', type: 'Practical', duration: 2, batches: ['A1','A2'], color: 'hsl(var(--chart-1))' },
    { id: 'aids5a-mon-2', subject: 'Recess', lecturer: 'N/A', room: 'N/A', day: 'Monday', time: '12:00-01:00', type: 'Recess', duration: 1, color: '#E0E0E0' },
    { id: 'aids5a-mon-3', subject: 'PE-I:CN/HPC', lecturer: 'ABP/Sharayu K', room: 'EL-204/EL-303', day: 'Monday', time: '01:00-02:00', type: 'Lecture', duration: 1, color: 'hsl(var(--chart-1))' },
    { id: 'aids5a-mon-4', subject: 'MDM:MS', lecturer: 'Hrushikesh P', room: 'EL-204', day: 'Monday', time: '02:00-03:00', type: 'Lecture', duration: 1, color: 'hsl(var(--chart-2))' },
    { id: 'aids5a-mon-5', subject: 'AI', lecturer: 'PI', room: 'EL-204', day: 'Monday', time: '03:00-04:00', type: 'Lecture', duration: 1, color: 'hsl(var(--chart-3))' },
    { id: 'aids5a-mon-6', subject: 'FML', lecturer: 'KRS', room: 'EL-102', day: 'Monday', time: '04:00-05:00', type: 'Lecture', duration: 1, color: 'hsl(var(--chart-4))' },

    // Tuesday
    { id: 'aids5a-tue-1', subject: 'FML', lecturer: 'KRS', room: 'EL-102', day: 'Tuesday', time: '10:00-11:00', type: 'Lecture', duration: 1, color: 'hsl(var(--chart-4))' },
    { id: 'aids5a-tue-2', subject: 'PE-I:CN/HPC', lecturer: 'ABP/Sharayu K', room: 'EL-204/EL-303', day: 'Tuesday', time: '11:00-12:00', type: 'Lecture', duration: 1, color: 'hsl(var(--chart-1))' },
    { id: 'aids5a-tue-3', subject: 'Recess', lecturer: 'N/A', room: 'N/A', day: 'Tuesday', time: '12:00-01:00', type: 'Recess', duration: 1, color: '#E0E0E0' },
    { id: 'aids5a-tue-4', subject: 'DAA', lecturer: 'RSK', room: 'EL-204', day: 'Tuesday', time: '01:00-02:00', type: 'Lecture', duration: 1, color: 'hsl(var(--chart-5))' },
    { id: 'aids5a-tue-5', subject: 'MDM:MS', lecturer: 'Hrushikesh P', room: 'EL-204', day: 'Tuesday', time: '02:00-03:00', type: 'Lecture', duration: 1, color: 'hsl(var(--chart-2))' },
    { id: 'aids5a-tue-6', subject: 'TFCS', lecturer: 'SAS', room: 'EL-204', day: 'Tuesday', time: '03:00-04:00', type: 'Lecture', duration: 1, color: 'hsl(var(--chart-1))' },
    { id: 'aids5a-tue-7', subject: 'AI', lecturer: 'PI', room: 'EL-204', day: 'Tuesday', time: '04:00-05:00', type: 'Lecture', duration: 1, color: 'hsl(var(--chart-3))' },
    ...
    { id: 'aids5a-wed-2', subject: 'OE:3 IBP', lecturer: 'S. Khalatkar', room: 'EL-204', day: 'Wednesday', time: '10:00-11:00', type: 'Lecture', duration: 1, color: 'hsl(var(--chart-2))' },
    { id: 'aids5a-wed-3', subject: 'LAB: AI/DAA', lecturer: 'PI, K. Khandare/RSK, Harsha', room: 'AIDS LAB 5,6/AIDS LAB 1', day: 'Wednesday', time: '11:00-12:00', type: 'Practical', duration: 2, batches: ['A1', 'A2', 'A3', 'A4'], color: 'hsl(var(--chart-3))' },
    { id: 'aids5a-wed-4', subject: 'Recess', lecturer: 'N/A', room: 'N/A', day: 'Wednesday', time: '01:00-02:00', type: 'Recess', duration: 1, color: '#E0E0E0' },
    { id: 'aids5a-wed-5', subject: 'MDM:MS', lecturer: 'Hrushikesh P', room: 'EL-204', day: 'Wednesday', time: '02:00-03:00', type: 'Lecture', duration: 1, color: 'hsl(var(--chart-2))' },
    { id: 'aids5a-wed-6', subject: 'DAA', lecturer: 'RSK', room: 'EL-204', day: 'Wednesday', time: '03:00-04:00', type: 'Lecture', duration: 1, color: 'hsl(var(--chart-5))' },
    ...
    // Thursday
    { id: 'aids5a-thu-1', subject: 'OE:3 IBP', lecturer: 'S. Khalatkar', room: 'EL-204', day: 'Thursday', time: '10:00-11:00', type: 'Lecture', duration: 1, color: 'hsl(var(--chart-2))' },
    { id: 'aids5a-thu-2', subject: 'TFCS', lecturer: 'SAS', room: 'EL-204', day: 'Thursday', time: '11:00-12:00', type: 'Lecture', duration: 1, color: 'hsl(var(--chart-1))' },
    { id: 'aids5a-thu-3', subject: 'PE-I:CN/HPC', lecturer: 'ABP/Sharayu K', room: 'EL-204/CT LAB 4', day: 'Thursday', time: '12:00-01:00', type: 'Lecture', duration: 1, color: 'hsl(var(--chart-1))' },
    { id: 'aids5a-thu-4', subject: 'Recess', lecturer: 'N/A', room: 'N/A', day: 'Thursday', time: '01:00-02:00', type: 'Recess', duration: 1, color: '#E0E0E0' },
    { id: 'aids5a-thu-5', subject: 'AI', lecturer: 'PI', room: 'EL-204', day: 'Thursday', time: '02:00-03:00', type: 'Lecture', duration: 1, color: 'hsl(var(--chart-3))' },
    { id: 'aids5a-thu-6', subject: 'DAA', lecturer: 'RSK', room: 'EL-204', day: 'Thursday', time: '03:00-04:00', type: 'Lecture', duration: 1, color: 'hsl(var(--chart-5))' },
    { id: 'aids5a-thu-7', subject: 'TFCS', lecturer: 'SAS', room: 'EL-204', day: 'Thursday', time: '04:00-05:00', type: 'Lecture', duration: 1, color: 'hsl(var(--chart-1))' },

    // Friday
    { id: 'aids5a-fri-1', subject: 'OE:3 IBP', lecturer: 'S. Khalatkar', room: 'EL-204', day: 'Friday', time: '10:00-11:00', type: 'Lecture', duration: 1, color: 'hsl(var(--chart-2))' },
    { id: 'aids5a-fri-2', subject: 'AI', lecturer: 'PI', room: 'EL-204', day: 'Friday', time: '11:00-12:00', type: 'Lecture', duration: 1, color: 'hsl(var(--chart-3))' },
    { id: 'aids5a-fri-3', subject: 'TFCS', lecturer: 'SAS', room: 'EL-204', day: 'Friday', time: '12:00-01:00', type: 'Lecture', duration: 1, color: 'hsl(var(--chart-1))' },
    { id: 'aids5a-fri-4', subject: 'Recess', lecturer: 'N/A', room: 'N/A', day: 'Friday', time: '01:00-02:00', type: 'Recess', duration: 1, color: '#E0E0E0' },
    { id: 'aids5a-fri-5', subject: 'LAB: AI/DAA', lecturer: 'PI, PVB/RSK, Harsha', room: 'AIDS LAB 5,6/AIDS LAB 1', day: 'Friday', time: '02:00-03:00', type: 'Practical', duration: 2, batches: ['A3', 'A4', 'A1', 'A2'], color: 'hsl(var(--chart-3))' },
];

const AIDS_7_SEM_A_TIMETABLE: TimetableEntry[] = [
    // Monday
    { id: 'aids7a-mon-1', subject: 'DL', lecturer: 'SSS', room: 'EL-203', day: 'Monday', time: '10:00-11:00', type: 'Lecture', duration: 1, color: 'hsl(var(--chart-1))' },
    { id: 'aids7a-mon-2', subject: 'BDH', lecturer: 'GMV', room: 'EL-203', day: 'Monday', time: '11:00-12:00', type: 'Lecture', duration: 1, color: 'hsl(var(--chart-2))' },
    { id: 'aids7a-mon-3', subject: 'PE-III: SNDA/DW', lecturer: 'NI/Sadaf', room: 'EL-211/EL-204', day: 'Monday', time: '12:00-01:00', type: 'Lecture', duration: 1, color: 'hsl(var(--chart-3))' },
    { id: 'aids7a-mon-4', subject: 'Recess', lecturer: 'N/A', room: 'N/A', day: 'Monday', time: '01:00-02:00', type: 'Recess', duration: 1, color: '#E0E0E0' },
    { id: 'aids7a-mon-5', subject: 'PE-V: D.SEC/OT', lecturer: 'SRK/Radhika', room: 'EL 103/ET 308', day: 'Monday', time: '02:00-03:00', type: 'Lecture', duration: 1, color: 'hsl(var(--chart-4))' },
    { id: 'aids7a-mon-6', subject: 'PE-IV: Dis Sy/CC', lecturer: 'SJK/AJ', room: 'EL 102, EL 303', day: 'Monday', time: '03:00-04:00', type: 'Lecture', duration: 1, color: 'hsl(var(--chart-5))' },
    ...
    // Tuesday
    { id: 'aids7a-tue-1', subject: 'LAB: HPC', lecturer: 'SSS, K. Khandare/SPP, SAG', room: 'AIDS LAB 1/AIDS LAB 5,6', day: 'Tuesday', time: '10:00-11:00', type: 'Practical', duration: 2, batches: ['A1','A2','A3','A4'], color: 'hsl(var(--chart-1))' },
    { id: 'aids7a-tue-2', subject: 'PE III: SNDA/DW', lecturer: 'NI/Sadaf', room: 'EL.211/EL.204', day: 'Tuesday', time: '12:00-01:00', type: 'Lecture', duration: 1, color: 'hsl(var(--chart-3))' },
    { id: 'aids7a-tue-3', subject: 'Recess', lecturer: 'N/A', room: 'N/A', day: 'Tuesday', time: '01:00-02:00', type: 'Recess', duration: 1, color: '#E0E0E0' },
    { id: 'aids7a-tue-4', subject: 'BDH', lecturer: 'GMV', room: 'EL-211', day: 'Tuesday', time: '02:00-03:00', type: 'Lecture', duration: 1, color: 'hsl(var(--chart-2))' },
    ...
    // Wednesday
    { id: 'aids7a-wed-1', subject: 'C.T.', lecturer: 'Hrushikesh P', room: 'ARCH AG 02B', day: 'Wednesday', time: '10:00-11:00', type: 'Lecture', duration: 1, color: 'hsl(var(--chart-5))' },
    { id: 'aids7a-wed-2', subject: 'PE V: D.SEC/OT', lecturer: 'SRK/Radhika', room: 'ARCH AG 02B/EL. 211', day: 'Wednesday', time: '11:00-12:00', type: 'Lecture', duration: 1, color: 'hsl(var(--chart-4))' },
    { id: 'aids7a-wed-3', subject: 'PE III: SNDA/DW', lecturer: 'NI/Sadaf', room: 'EL. 211/ET. 204', day: 'Wednesday', time: '12:00-01:00', type: 'Lecture', duration: 1, color: 'hsl(var(--chart-3))' },
    { id: 'aids7a-wed-4', subject: 'Recess', lecturer: 'N/A', room: 'N/A', day: 'Wednesday', time: '01:00-02:00', type: 'Recess', duration: 1, color: '#E0E0E0' },
    { id: 'aids7a-wed-5', subject: 'DI.', lecturer: 'SSS', room: 'EL. 211', day: 'Wednesday', time: '02:00-03:00', type: 'Lecture', duration: 1, color: 'hsl(var(--chart-1))' },
    { id: 'aids7a-wed-6', subject: 'LAB: DL/BDH', lecturer: 'SSS, CSS/GMV, SPP', room: 'AIDS LAB 1/AIDS LAB 2', day: 'Wednesday', time: '03:00-04:00', type: 'Practical', duration: 2, batches: ['A1','A2','A3','A4'], color: 'hsl(var(--chart-2))' },

    // Thursday
    { id: 'aids7a-thu-1', subject: 'LAB: DL/BDH', lecturer: 'SSS, Sadaf/GMV, SPP', room: 'AIDS LAB 1/AIDS LAB 2', day: 'Thursday', time: '10:00-11:00', type: 'Practical', duration: 2, batches: ['A3','A4','A1','A2'], color: 'hsl(var(--chart-2))' },
    { id: 'aids7a-thu-2', subject: 'PE-IV: DS/CC', lecturer: 'SJK/AJ', room: 'EL 211/ARCH AG 02B', day: 'Thursday', time: '12:00-01:00', type: 'Lecture', duration: 1, color: 'hsl(var(--chart-5))' },
    { id: 'aids7a-thu-3', subject: 'Recess', lecturer: 'N/A', room: 'N/A', day: 'Thursday', time: '01:00-02:00', type: 'Recess', duration: 1, color: '#E0E0E0' },
    { id: 'aids7a-thu-4', subject: 'CL', lecturer: 'Hrushikesh P', room: 'EL 203', day: 'Thursday', time: '02:00-03:00', type: 'Lecture', duration: 1, color: 'hsl(var(--chart-5))' },
    { id: 'aids7a-thu-5', subject: 'BDH', lecturer: 'GMV', room: 'EL-302', day: 'Thursday', time: '03:00-04:00', type: 'Lecture', duration: 1, color: 'hsl(var(--chart-2))' },
    { id: 'aids7a-thu-6', subject: 'Sports', lecturer: 'N/A', room: 'N/A', day: 'Thursday', time: '04:00-05:00', type: 'Sports', duration: 1, color: '#E0E0E0' },

    // Friday
    { id: 'aids7a-fri-1', subject: 'PE-IV: DS/CC', lecturer: 'SJK/AJ', room: 'EL211/ARCH AG 02B', day: 'Friday', time: '10:00-11:00', type: 'Lecture', duration: 1, color: 'hsl(var(--chart-5))' },
    { id: 'aids7a-fri-2', subject: 'PE-V: D.SEC/OT', lecturer: 'SRK/Radhika', room: 'ARCH AG 02B/EL-211', day: 'Friday', time: '11:00-12:00', type: 'Lecture', duration: 1, color: 'hsl(var(--chart-4))' },
    { id: 'aids7a-fri-3', subject: 'CL', lecturer: 'Hrushikesh P', room: 'EL-204', day: 'Friday', time: '12:00-01:00', type: 'Lecture', duration: 1, color: 'hsl(var(--chart-5))' },
    { id: 'aids7a-fri-4', subject: 'Recess', lecturer: 'N/A', room: 'N/A', day: 'Friday', time: '01:00-02:00', type: 'Recess', duration: 1, color: '#E0E0E0' },
    { id: 'aids7a-fri-5', subject: 'DL', lecturer: 'SSS', room: 'EL-211', day: 'Friday', time: '02:00-03:00', type: 'Lecture', duration: 1, color: 'hsl(var(--chart-1))' },
    { id: 'aids7a-fri-6', subject: 'Library', lecturer: 'PROF. SADAF', room: 'N/A', day: 'Friday', time: '03:00-04:00', type: 'Library', duration: 1, color: '#E0E0E0' },
